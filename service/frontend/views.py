...
def home(request):
    ...
    return render(request, 'mobiles/index.html', locals())
...
def channel(request, slug):
    ...
    # menu = navigation()
    return render(request, 'mobiles/channel.html', locals())
...
def detail(request, id):
    ...
    # menu = navigation()       
    return render(request, 'mobiles/detail.html', locals())

# @cache_page(60 * 15)
# @minified_response
def player(request, id):  
    return render(request, 'mobiles/player.html', locals())
...
def browse(request):
    ...
    return render(request, 'mobiles/browse.html', context)

# @cache_page(60 * 15)
@minified_response
def live(request):
    context = {}
    return render(request, 'mobiles/live.html', context)
